...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/hardware-readiness
Call log:
  - navigating to "http://127.0.0.1:4173/hardware-readiness", waiting until "load"
