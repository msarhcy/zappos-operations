...
- Name: protected-routes.spec.ts >> redirects unauthenticated access for /notifications
- Location: tests/e2e/protected-routes.spec.ts:33:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/notifications
Call log:
  - navigating to "http://127.0.0.1:4173/notifications", waiting until "load"
