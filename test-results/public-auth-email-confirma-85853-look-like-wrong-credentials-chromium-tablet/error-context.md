...
- Name: public-auth.spec.ts >> email confirmation callback errors do not look like wrong credentials
- Location: tests/e2e/public-auth.spec.ts:87:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/auth#error_description=Email%20not%20confirmed
Call log:
  - navigating to "http://127.0.0.1:4173/auth#error_description=Email%20not%20confirmed", waiting until "load"
