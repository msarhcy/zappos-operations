...
- Name: public-auth.spec.ts >> forgot password page renders without authenticated state
- Location: tests/e2e/public-auth.spec.ts:96:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/forgot-password
Call log:
  - navigating to "http://127.0.0.1:4173/forgot-password", waiting until "load"
